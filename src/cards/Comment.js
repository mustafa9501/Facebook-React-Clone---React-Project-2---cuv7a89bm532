...
const Comment = ({ onClose }) => {
    ...
    return (<>
        {isScreenSmall ? (
             <div className="fixed h-screen w-screen flex items-center justify-center bg-[#F3F3F4] bg-opacity-90 mb-4 z-40">
             <div className="main_popup bg-white w-screen mx-0.5 my-0.5 h-full rounded-lg drop-shadow-xl overflow-y-auto scrollbar">
