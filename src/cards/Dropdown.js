...
const Dropdown = ({id}) => {
    ...
    <>  
        {isScreenSmall ? (
            <div
            className="absolute right-0 mt-14 mr-4 w-2/4 origin-top-right rounded-md bg-white text-zinc-200 font-semibold py-2 px-2 focus:outline-none"
            role="menu"
            ...
            <Link to="/updatepost"><div className='Settings text-md flex gap-4 cursor-pointer rounded-md hover:bg-[#F2F2F2] py-2 px-2' onClick={()=>popupUpdateOpen(id)}>
