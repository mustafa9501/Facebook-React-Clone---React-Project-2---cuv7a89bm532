...
const UpdatePost = ({ onClose, id }) => {
    ...
    return (
        <>
            {isScreenSmall ? (
                <div className="h-screen w-screen flex items-center justify-center bg-[#F3F3F4]">
                    <div className="main_popup bg-white w-full h-4/6 mx-3 rounded-lg drop-shadow-xl overflow-y-auto scrollbar-post">
