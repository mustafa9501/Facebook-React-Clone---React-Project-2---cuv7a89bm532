...
const Menu = () => {
    ...
    const { openPopup } = useUser();

    return (<>

        <div
            className="absolute right-0 mt-14 mr-4 w-2/5 origin-top-right rounded-md bg-[#F7F8FA] text-zinc-200 py-2 px-2 focus:outline-none"
            role="menu"
            ...
            <div className='flex gap-3 pt-3 m-3'>
                ...
                <div className='left bg-white rounded-md w-2/3'>
                    <div className='font-semibold text-xl pl-3 text-black'>Social</div>
                ...
                <div className='right bg-white rounded-md w-1/3'>

                    <div className='text-black font-semibold text-xl pl-3 pt-3'>Create</div>
                    ...
                    <div className='pt-2' onClick={openPopup}>
                        <div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-pointer'>
                            ...
                            <h3 className='font-semibold text-black pt-1'>Post</h3>
                        </div>
                    </div>
                    <div className='pt-2'>
                        <Link to='/pages/createpage'><div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-pointer'>
                            ...
                            <h3 className='font-semibold text-black pt-1'>Create Page</h3>
                        </div></Link>
                    </div>
                    <div className='pt-2'>
                        <div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-not-allowed'>
                            ...
                            <h3 className='font-semibold text-black pt-1'>Reel</h3>
                        </div>
                    </div>
                    <div className='pt-2'>
                        <div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-not-allowed'>
                            <Icon icon="mdi:star-settings" width="2rem" height="2rem" style={{ color: '#484747' }} className='bg-[#E4E6EB] rounded-full p-1' />
                            <h3 className='font-semibold text-black pt-1'>Live event</h3>
                        </div>
                    </div>
                    <div className='pt-2'>
                        <div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-not-allowed'>
                            <Icon icon="mdi:loudspeaker" width="2rem" height="2rem" style={{ color: '#484747' }} className='bg-[#E4E6EB] rounded-full p-1' />
                            <h3 className='font-semibold text-black pt-1'>Ad</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div className='text-gray-500 text-xs pl-4 pt-1.5'>Privacy  · Terms  · Advertising  · Ad Choices   · Cookies  ·   · Meta © 2024</div>
        </div>
    </>
    )
}
