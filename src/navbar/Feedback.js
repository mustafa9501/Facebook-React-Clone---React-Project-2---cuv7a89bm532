        ...
        <>
            <div
                ...
                <div className='Settings flex gap-5 ml-4 '>
                    ...
                    <h2 className='text-2xl text-black font-bold mt-1 px-2 py-3 dark:text-white'> Give feedback</h2>
                </div>
                ...
                text-lg p-5 flex gap-3'>
                    ...
                    <h3 className='pt-1 text-zinc-700 dark:text-zinc-400'>This feature is coming soon !!</h3>
                </div>
            </div>
        </>
    )
