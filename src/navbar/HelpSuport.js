        ...
        <>
            <div
                ...
                <div className='Settings flex gap-5 ml-4 '>
                    ...
                    <h2 className='text-2xl text-black font-bold mt-1 px-2 py-3 dark:text-white '>Help & support</h2>
                </div>
                <div className='border-b border-slate-400 mt-2 dark:border-slate-700'></div>
