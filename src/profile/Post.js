...
const Post = () => {
    ...
    return (
        <>
            {isScreenSmall ? (
                <>
                    <div className='w-full rounded-lg bg-white mt-5 pl-6 px-4'>
                        <h2 className='font-bold text-lg pb-2'>Intro</h2>
                        ...
                        <div className='w-full rounded-lg bg-white mt-4  py-4 flex justify-between'>
                            <h3 className='font-bold text-md'>Photos</h3>
                            <h3 className='text-md text-[#0861F2] cursor-not-allowed'>See all photos</h3>
                        </div>
                        <div className='w-full rounded-lg bg-white py-4 flex justify-between'>
                            <h3 className='font-bold text-md'>Friends</h3>
                            <h3 className='text-md text-[#0861F2] cursor-not-allowed'>See all photos</h3>
                        </div>
                    </div>
                    ...
                    <div className='w-full'>
                        {getPost.map((obj) => (
                            <Card key={obj._id} className="w-full rounded-xl mt-6">
                                ...
                                <CardFooter className="flex justify-between px-5 pb-4 pt-1
                                ">
