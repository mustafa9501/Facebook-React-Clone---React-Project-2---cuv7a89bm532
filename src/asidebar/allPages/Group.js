    ...
    return (<>
        {isScreenSmall ? (
            ...
            <div className='Part-1 h-full bg-white pl-4 pt-3  '>
                ...
                <div className='text-zinc-600 hover:bg-[#d3dde5] rounded-lg px-2 py-1.5 mr-4 mt-5 text-center font-semibold cursor-not-allowed bg-[#e2f1ef]'>+ Create new group</div>

                <div className='border-b border-gray-300 pl-3 mr-4 mt-3'></div>
                <div className='flex justify-evenly overflow-x-auto scrollbar'>
                    <div className='flex mt-5 bg-[#d9dbe0] cursor-not-allowed rounded-full  py-1.5 px-2'>
                        <Icon icon="material-symbols:feed" width="1.8rem" height="1.8rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                        <h3 className='font-semibold text-sm text-black mt-1'>Your feed</h3>
                    </div>
                    <div className='flex  mt-5 cursor-not-allowed rounded-full bg-[#d9dbe0] py-1.5 px-2 '>
                        <Icon icon="iconamoon:discover-fill" width="1.8rem" height="1.8rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                        <h3 className='font-semibold text-sm text-zinc-black mt-1'>Discover</h3>
                    </div>
                    <div className='flex mt-5 bg-[#d9dbe0] cursor-not-allowed rounded-full  py-1.5 px-2 '>
                        <Icon icon="material-symbols:groups" width="1.8rem" height="1.8rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                        <h3 className='font-semibold text-sm text-black mt-1'>Your groups</h3>
                    </div>
                </div>
