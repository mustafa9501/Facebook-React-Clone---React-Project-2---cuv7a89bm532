        ...
        <div className={`${darkTheme && 'dark'}`}>
            ...
            <div className='Part-1 h-full bg-white dark:bg-[#18191A] pl-4 pt-3  '>
                <div className='flex justify-between pr-4'>
                    <h4 className='text-2xl font-bold dark:text-white'>Marketplace</h4>
                ...
                <div className='text-zinc-600 hover:bg-[#d3dde5] rounded-lg px-2 py-1.5 mr-4 mt-5 text-center font-semibold cursor-not-allowed bg-[#e2f1ef] dark:bg-[#323436] dark:text-white'>+ Create new listing</div>

                <div className='border-b border-gray-300 pl-3 mr-4 mt-3'></div>
                <div className='flex justify-evenly gap-1 overflow-x-auto scrollbar'>
                    <div className='flex gap-1 mt-5 bg-[#d9dbe0] dark:bg-[#323436] cursor-not-allowed rounded-full  py-1.5 px-2 pr-3'>
                        ...
                        <h3 className='font-semibold text-sm text-black mt-1 dark:text-white'>Browse</h3>
                    </div>
                    <div className='flex gap-1 mt-5 cursor-not-allowed rounded-full bg-[#d9dbe0] dark:bg-[#323436] py-1.5 px-2 pr-2.5'>
                        ...
                        <h3 className='font-semibold text-sm text-zinc-black mt-1 dark:text-white'>Inbox</h3>
                    </div>
                    <div className='flex gap-1 mt-5 bg-[#d9dbe0] dark:bg-[#323436] cursor-not-allowed rounded-full  py-1.5 px-2 pr-3'>
                        <Icon icon="mdi:movie-open-play" width="1.8rem" height="1.8rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                        <h3 className='font-semibold text-sm text-black mt-1 dark:text-white'>Buying</h3>
                    </div>
                    <div className='flex gap-1 mt-5 bg-[#d9dbe0] dark:bg-[#323436] cursor-not-allowed rounded-full  py-1.5 px-2 pr-3'>
                        <Icon icon="mdi:movie-open-play" width="1.8rem" height="1.8rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                        <h3 className='font-semibold text-sm text-black mt-1 dark:text-white'>Selling</h3>
                    </div>
                    <div className='flex gap-1 mt-5 bg-[#d9dbe0] dark:bg-[#323436] cursor-not-allowed rounded-full  py-1.5 px-2 pr-3'>
                        <Icon icon="ri:live-fill" width="1.8rem" height="1.8rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                        <h3 className='font-semibold text-sm text-black mt-1 dark:text-white'>Notifications</h3>
                    </div>
                </div>
            ...
            <div className='Part-1 w-1/7 h-full bg-white pl-4 pt-3  dark:bg-[#242526]' style={{ boxShadow: '0px 3px 2px 2px rgba(0, 0, 0, 0.1)' }}>
                ...
                <div className='Search'>
                    <input type='text' className='bg-[#F0F2F5] dark:bg-[#323436] rounded-full mt-2.5 py-1.5 px-10 w-5/7 focus:outline-none' placeholder='Search Marketplace' />
                </div>
                ...
                <div className='flex gap-4 mt-5 px-1 hover:bg-[#f0f2f5] hover:hover:dark:bg-[#4d5053] cursor-not-allowed rounded-lg mr-4 py-1.5'>
                    ...
                    <h3 className='font-semibold text-lg text-zinc-600 mt-1 dark:text-white'>Browse all</h3>
                </div>
                <div className='flex gap-4 mt-3 px-1 hover:bg-[#f0f2f5] hover:hover:dark:bg-[#4d5053] cursor-not-allowed rounded-lg mr-4 py-1.5'>
                    ...
                    <h3 className='font-semibold text-lg text-zinc-600 mt-1 dark:text-white'>Notifications</h3>
                </div>
                <div className='flex gap-4 px-1 mt-3 hover:bg-[#f0f2f5] hover:hover:dark:bg-[#4d5053] cursor-not-allowed rounded-lg mr-4 py-1.5'>
                    <Icon icon="mage:video-player-fill" width="2rem" height="2rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                    <h3 className='font-semibold text-lg text-zinc-600 mt-1 dark:text-white'>Inbox</h3>
                </div>
                <div className='flex gap-4 px-1 mt-3 hover:bg-[#f0f2f5] hover:hover:dark:bg-[#4d5053] cursor-not-allowed rounded-lg mr-4 py-1.5'>
                    <Icon icon="mdi:movie-open-play" width="2rem" height="2rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                    <h3 className='font-semibold text-lg text-zinc-600 mt-1 dark:text-white'>Buying</h3>
                </div>
                <div className='flex gap-4 mt-3 px-1 hover:bg-[#f0f2f5] hover:hover:dark:bg-[#4d5053] cursor-not-allowed rounded-lg mr-4 py-1.5'>
                    <Icon icon="mdi:movie-open-play" width="2rem" height="2rem" style={{ color: 'gray' }} className='rounded-full bg-[#d9dbe0] p-1' />
                    <h3 className='font-semibold text-lg text-zinc-600 mt-1 dark:text-white'>Selling</h3>
                </div>
                <div className='text-zinc-600 hover:bg-[#d3dde5] hover:hover:dark:bg-[#4d5053] rounded-lg px-2 py-1.5 mr-4 mt-5 text-center font-semibold cursor-not-allowed bg-[#e2f1ef] dark:bg-[#323436] dark:text-white'>+ Create new listing</div>
            </div>
            <div className='Part-2 font-bold text-3xl p-5 text-center flex m-auto items-center dark:text-white'>This page is coming soon !!</div>
        </div>
        )}    
