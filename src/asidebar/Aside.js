...
const Aside = () => {
  const {getName, onClickMidNav, getUser, userIdHandler, userId} = useUser();
  ...
  return (
    <div className='px-3 py-3'>
        ...
        <Link to='/profile/post'>
          <div className='flex hover:bg-[#e6e3e3] hover:rounded-md cursor-pointer px-1 py-2' onClick={() => userIdHandler(profileInfo._id)}>
            <img
              src={Profile}
              alt="Profile"
              className='w-10 h-10 rounded-full cursor-pointer bg-[#d3d1d1]'
            />
            <h3 className='text-black pl-4 pt-2 text-base font-semibold'>{profileInfo.name}</h3>
          </div>
        </Link>
      )}
        ...
        <Link to='/group'><div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-not-allowed'>
        <Icon icon="el:group-alt" width="1.5rem" height="1.5rem"  style={{color: '#1B82E9'}} />
        <h3 className='pt-0.5 font-semibold'>Groups</h3>
        </div></Link>
        
        <Link to='/videos'><div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-not-allowed'>
        <Icon icon="mdi:youtube-tv" width="1.5rem" height="1.5rem"  style={{color: '#1B82E9'}} />
        <h3 className='pt-0.5 font-semibold'>Videos</h3>
        </div></Link>

        <Link to='/marketplace'><div className='flex gap-4 px-2 py-2 hover:bg-[#e6e3e3] hover:rounded-md cursor-not-allowed'>
